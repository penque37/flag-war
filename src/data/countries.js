export const COUNTRIES = [
  ...
  { name: "DR Congo", code: "CD" }, { name: "Ecuador", code: "EC" },
...
// Higher number = more likely to appear in the 1-ad random draw.
// Any country not listed defaults to weight 1.
export const FLAG_WEIGHTS = {
  US: 20, CN: 18, IN: 18, BR: 15, RU: 15, GB: 14, DE: 12,
  FR: 12, JP: 12, AU: 10, CA: 10, MX: 10, KR: 9,  IT: 8,
  ES: 8,  NG: 7,  ZA: 7,  AR: 7,  TR: 6,  SA: 6,  ID: 6,
  PK: 5,  EG: 5,  TH: 5,  PH: 5,  UA: 5,  NL: 4,  SE: 4,
  NO: 4,  CH: 4,  PT: 4,  GR: 4,  PL: 4,  IL: 4,  SG: 4,
};